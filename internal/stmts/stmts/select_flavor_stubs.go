...
func GenSelectWithNestedCaseWithFlavor(db *sql.DB, lcg *common.LCG, maxDepth int, flavor FlavorConfig) (SelectStmt, error) {
...
func GenSelectWithComplexJoinWithFlavor(db *sql.DB, lcg *common.LCG, maxDepth int, flavor FlavorConfig) (SelectStmt, error) {
...
func GenSelectDeeplyNestedWithFlavor(db *sql.DB, lcg *common.LCG, maxDepth int, flavor FlavorConfig) (SelectStmt, error) {
...
func GenSelectWithWindowFunctionWithFlavor(db *sql.DB, lcg *common.LCG, flavor FlavorConfig) (SelectStmt, error) {
...
func GenSelectWithMultipleWindowsWithFlavor(db *sql.DB, lcg *common.LCG, flavor FlavorConfig) (SelectStmt, error) {
	return GenSelectWithMultipleWindows(db, lcg)
}

// GenSelectWithCTEWithFlavor is a flavor-aware version of GenSelectWithCTE
func GenSelectWithCTEWithFlavor(db *sql.DB, lcg *common.LCG, flavor FlavorConfig) (SelectStmt, error) {
	return GenSelectWithCTE(db, lcg)
}

// GenSelectWithMultipleCTEWithFlavor is a flavor-aware version of GenSelectWithMultipleCTE
func GenSelectWithMultipleCTEWithFlavor(db *sql.DB, lcg *common.LCG, flavor FlavorConfig) (SelectStmt, error) {
...
func GenSelectWithRecursiveCTEWithFlavor(db *sql.DB, lcg *common.LCG, flavor FlavorConfig) (SelectStmt, error) {
...
func GenSelectWithJSONFunctionWithFlavor(db *sql.DB, lcg *common.LCG, flavor FlavorConfig) (SelectStmt, error) {
...
func GenSelectWithUUIDFunctionWithFlavor(db *sql.DB, lcg *common.LCG, flavor FlavorConfig) (SelectStmt, error) {
...
func GenSelectWithRegexpFunctionWithFlavor(db *sql.DB, lcg *common.LCG, flavor FlavorConfig) (SelectStmt, error) {
...
func GenSelectWithVectorFunctionWithFlavor(db *sql.DB, lcg *common.LCG, flavor FlavorConfig) (SelectStmt, error) {
...
func GenSelectWithTimeFunctionWithFlavor(db *sql.DB, lcg *common.LCG, flavor FlavorConfig) (SelectStmt, error) {
