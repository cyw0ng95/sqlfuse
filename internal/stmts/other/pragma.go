...
type PragmaValueGenerator func(pragma string, lcg *common.LCG, flavor stmts.FlavorConfig) string
...
// PragmaGenerator is a stmts.StmtGenerator for PRAGMA statements.
...
var pragmaDefinitions = map[string]PragmaDefinition{
	...
	"application_id": {
		...
		GenerateValue: func(pragma string, lcg *common.LCG, flavor stmts.FlavorConfig) string {
...
func getSupportedPragmas(flavor stmts.FlavorConfig) []string {
	if flavor == nil {
...
func (g *PragmaGenerator) Generate(ctx *stmts.GenContext) (stmts.Stmt, error) {
	return genPragmaWithFlavor(ctx.LCG, ctx.Flavor), nil
}

// CanGenerate implements stmts.StmtGenerator. PRAGMA can always be generated.
func (g *PragmaGenerator) CanGenerate(ctx *stmts.GenContext) bool {
	return true
}
...
func GenPragma(lcg *common.LCG) stmts.Stmt {
	return genPragmaWithFlavor(lcg, stmts.GetDefaultFlavor())
}
...
func genPragmaWithFlavor(lcg *common.LCG, flavor stmts.FlavorConfig) stmts.Stmt {
	if flavor == nil {
		flavor = stmts.GetDefaultFlavor()
	}
